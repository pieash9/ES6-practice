...
/* let data = [
 ...
 const final = data[3].pHeroCourses['course-xyz'];
 const final2 = data[3].locationField['en-US'].lon
 console.log(final2);
 console.log(final); */

//3) How will you get the output a) abc b) xyz
...
// How will you display a) Petersburg b) Harry
...
// 7) How will you display a) habluder adda b) Beginner
/* let data = {
  data: [
    {
      bookId: 1,
